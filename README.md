...
```bash
npm install @Veynarl/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @Veynarl/baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@Veynarl/baileys")
```
...
```javascript
const makeWASocket = require("@Veynarl/baileys").default;
const { useMultiFileAuthState } = require("@Veynarl/baileys");
...
```javascript
const makeWASocket = require("@Veynarl/baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@Veynarl/baileys");
...
```javascript
const makeWASocket = require("@Veynarl/baileys").default;
const { makeInMemoryStore } = require("@Veynarl/baileys");
...
const { downloadMediaMessage, getContentType } = require("@Veynarl/baileys");
